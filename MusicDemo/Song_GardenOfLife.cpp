...
// WARNING: Pattern 6 is a duplicate and can be replaced by 2
// WARNING: Pattern 12 is a duplicate and can be replaced by 11
// WARNING: Pattern 17 is a duplicate and can be replaced by 0
// WARNING: Pattern 18 is a duplicate and can be replaced by 1
// This file is automatically generated using import-from-p8.py

const NoteSpec sfx5Notes[32] = {
...
const TuneSpec sfx5 = TuneSpec {
    .noteDuration = 24, .loopStart = 32, .numNotes = 32, .notes = sfx5Notes
};
const NoteSpec sfx6Notes[32] = {
    NoteSpec { .note=Note::A4, .vol=7, .wav=WaveForm::PHASER, .fx=Effect::NONE },
    NoteSpec { .note=Note::G4, .vol=6, .wav=WaveForm::PHASER, .fx=Effect::NONE },
    NoteSpec { .note=Note::E4, .vol=5, .wav=WaveForm::PHASER, .fx=Effect::NONE },
    NoteSpec { .note=Note::E4, .vol=4, .wav=WaveForm::PHASER, .fx=Effect::SLIDE },
...
const TuneSpec sfx6 = TuneSpec {
    .noteDuration = 24, .loopStart = 32, .numNotes = 32, .notes = sfx6Notes
};
const NoteSpec sfx7Notes[32] = {
    NoteSpec { .note=Note::A4, .vol=7, .wav=WaveForm::PHASER, .fx=Effect::NONE },
    NoteSpec { .note=Note::G4, .vol=6, .wav=WaveForm::PHASER, .fx=Effect::NONE },
    NoteSpec { .note=Note::E4, .vol=5, .wav=WaveForm::PHASER, .fx=Effect::NONE },
    NoteSpec { .note=Note::E4, .vol=4, .wav=WaveForm::PHASER, .fx=Effect::SLIDE },
...
const TuneSpec sfx7 = TuneSpec {
    .noteDuration = 24, .loopStart = 32, .numNotes = 32, .notes = sfx7Notes
};
...
const TuneSpec *const pattern0Tunes[4] = { &sfx13, &sfx18, &sfx25, &sfx31 };
const PatternSpec pattern0 = PatternSpec {
    .numTunes = 4, .tunes = pattern0Tunes
};
const TuneSpec *const pattern1Tunes[4] = { &sfx13, &sfx19, &sfx26, &sfx31 };
const PatternSpec pattern1 = PatternSpec {
    .numTunes = 4, .tunes = pattern1Tunes
};
const TuneSpec *const pattern2Tunes[1] = { &sfx5 };
...
const TuneSpec *const pattern4Tunes[1] = { &sfx5 };
const PatternSpec pattern4 = PatternSpec {
    .numTunes = 1, .tunes = pattern4Tunes
};
const TuneSpec *const pattern5Tunes[1] = { &sfx6 };
const PatternSpec pattern5 = PatternSpec {
    .numTunes = 1, .tunes = pattern5Tunes
};
const TuneSpec *const pattern6Tunes[1] = { &sfx5 };
const PatternSpec pattern6 = PatternSpec {
    .numTunes = 1, .tunes = pattern6Tunes
};
...
const TuneSpec *const pattern12Tunes[4] = { &sfx11, &sfx17, &sfx22, &sfx30 };
const PatternSpec pattern12 = PatternSpec {
    .numTunes = 4, .tunes = pattern12Tunes
};
...
const SongSpec song0 = SongSpec {
    .loopStart = 0, .numPatterns = 2, .patterns = song0Patterns
};
...
const PatternSpec *const song4Patterns[2] = {
    &pattern4,
    &pattern5,
};
const SongSpec song4 = SongSpec {
    .loopStart = 1, .numPatterns = 2, .patterns = song4Patterns
};
const PatternSpec *const song6Patterns[1] = {
    &pattern6,
};
const SongSpec song6 = SongSpec {
    .loopStart = 0, .numPatterns = 1, .patterns = song6Patterns
};
